...
public class VagaIT {
    ...
    public void criarVaga_ComDadosValidos_RetornarLocationStatus201(){
        testClient
                ...
                .bodyValue(new VagasCreateDto("A-05", "LIVRE"))
                .exchange()
    ...
    public void criarVaga_ComDadosInvalidos_RetornarErrorMessageComStatus422(){
        ...
        testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
                .bodyValue(new VagasCreateDto("A-501", "DESOCUPADA"))
                .exchange()
                .expectStatus().isEqualTo(409)
                .expectBody()
                .jsonPath("status").isEqualTo(422)
    ...
    @Test
    public void criarVaga_ComUsuarioSemPermissao_RetornarStatus403() {
        testClient
                .post()
                .uri("/api/v1/vagas")
                .contentType(MediaType.APPLICATION_JSON)
                ...
                .bodyValue(new VagasCreateDto("A-05", "OCUPADA"))
                .exchange()
                .expectStatus().isForbidden()
                .expectBody()
                .jsonPath("status").isEqualTo(403)
