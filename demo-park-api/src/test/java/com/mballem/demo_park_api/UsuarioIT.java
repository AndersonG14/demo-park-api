...
public class UsuarioIT {
    ...
    @Test
    public void editarSenha_ComCamposInvalidos_RetornarErroMessageComStatus422() {
        ErrorMessage responseBody = testClient
                .patch()
                .uri("/api/v1/usuarios/100")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void editarSenha_ComSenhaInvalidas_RetornarErroMessageComStatus400() {
        ErrorMessage responseBody = testClient
                .patch()
                .uri("/api/v1/usuarios/100")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void listarUsuarios_ComSucesso_RetornarListaComStatus200() {
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody).isNotNull();
        org.assertj.core.api.Assertions.assertThat(responseBody.size()).isEqualTo(totalDeUsuarios);
    }
}
