...
insert into CLIENTES(id, cpf, nome, id_usuario) values (10, '24906635008', 'Bianca Silva', 101);
insert into CLIENTES(id, cpf, nome, id_usuario) values (20, '16744245074', 'Roberto Gomes', 102);
