...
@Tag(name = "Autenticação", description = "Recuros para proceder com a autenticação na API")
@Slf4j
...
public class AutenticacaoController {
    ...
    @Operation(summary = "Autenticar na API", description = "Recurso de autenticação na API",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Atualização realizada com sucesso e retorno de bearer token",
    ...
    public ResponseEntity<?> autenticar(@RequestBody @Valid UsuarioLoginDto dto, HttpServletRequest request){
        ...
        try {
            ...
            log.warn("Bad Crendentials from username '{}'", dto.getUsername());
        }
