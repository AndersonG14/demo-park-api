...
@Tag(name = "Usuarios", description = "Contém todoas as operações relativas aos recursos para cadastro, edição e leitura de um usuário.")
...
public class UsuarioController {
    ...
    public ResponseEntity<Void> upadtePassword(@PathVariable Long id, @Valid @RequestBody UsuarioSenhaDto dto){
        Usuario user = usuarioService.editarSenha(id, dto.getSenhaAtual(), dto.getNovaSenha(), dto.getConfirmaSenha());
        return ResponseEntity.noContent().build();
    }

    @Operation(summary = "Listar todos os usuários cadastradoes", description = "Requisição exige um Bearer Token. Acesso restrito a ADMIN",
            security = @SecurityRequirement(name = "security"),
            responses = {
